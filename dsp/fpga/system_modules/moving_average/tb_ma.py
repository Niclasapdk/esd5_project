...
async def top_test(dut):
    ...
    for xi in input_array:
        ...
        await Timer(1)
        dut.clk.value = 1
        print(f"Input: ma_input={xi}, Expected: ma_sum={expected_sum}, ma_out={expected_out}, Got: ma_sum={dut.ma_sum.value.signed_integer}, ma_out={dut.ma_out.value.signed_integer}")
        
        assert expected_sum == dut.ma_sum.value.signed_integer
        assert expected_out - dut.ma_out.value.signed_integer <= 0.51
