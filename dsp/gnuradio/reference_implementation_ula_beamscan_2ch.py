...
class reference_implementation_ula_beamscan_2ch(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.snapshot_count = snapshot_count = 64
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, f"/home/markus/uni/esd5_project/dsp/simulation_data/ula_4ch_sim_data_{targets}_targets_{in_snr}dB_snr.raw", True, 0, 0)
