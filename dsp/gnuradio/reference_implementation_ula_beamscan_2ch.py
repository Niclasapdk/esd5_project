...
class reference_implementation_ula_beamscan_2ch(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.snapshot_count = snapshot_count = 1024
        ...
        self.uhd_usrp_source_0_0.set_gain(gain-6, 1)
        ...
        self.connect((self.uhd_usrp_source_0, 1), (self.qtgui_const_sink_x_0_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0_0, 1), (self.epy_block_1, 3))
        self.connect((self.uhd_usrp_source_0_0, 0), (self.epy_block_1, 2))
        self.connect((self.uhd_usrp_source_0_0, 0), (self.qtgui_const_sink_x_0_0_0, 0))
        self.connect((self.uhd_usrp_source_0_0, 1), (self.qtgui_const_sink_x_0_0_0_0, 0))
    ...
    def set_gain(self, gain):
        ...
        self.uhd_usrp_source_0_0.set_gain(self.gain-6, 1)
