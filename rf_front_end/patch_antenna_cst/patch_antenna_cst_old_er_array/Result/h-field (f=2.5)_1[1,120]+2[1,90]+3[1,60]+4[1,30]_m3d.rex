...
<MetaResultFile version="20211011" creator="Solver HFTD - Field 3DFD Monitor Combine Result">
  ...
  <SimulationProperties fieldname="h-field (f=2.5) [1[1,120]+2[1,90]+3[1,60]+4[1,30]]" frequency="2.5" encoded_unit="&amp;U:A^1.:m^-1" quantity="h-field" fieldtype="H-Field" fieldscaling="PEAK" dB_Amplitude="20"/>
