...
<MetaResultFile version="20211011" creator="Solver HFTD - Field 3DFD Monitor Combine Result">
  ...
  <SimulationProperties fieldname="h-field (f=3.2) [1[1,0]+2[1,0]+3[1,0]+4[1,0]]" frequency="3.2000000000000002" encoded_unit="&amp;U:A^1.:m^-1" quantity="h-field" fieldtype="H-Field" fieldscaling="PEAK" dB_Amplitude="20"/>
